...
var db;
url = process.env.MONGO_URL ||"mongodb://127.0.0.1:27017/?readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false";
mongoClient.connect(url, function (err, client) {
    if (err) throw err;
    db = client.db("euphony");
});
