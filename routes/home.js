...
var spotifyApi = new SpotifyWebApi({
    clientId: '4b37e9029f3241e29ec40e6b98f93ce8',
    clientSecret: '883840c0390a45bb99890ba3d4c3aa0a'
});
...
router.get('/', function (req, res) {
    spotifyApi.getAlbums(['43TAlCzzm5cC97LPwit4n0', '4ceWEQarPyTyeb9TUeyLOG',
        ...
        function (err, data) {
            ...
            spotifyApi.getAlbumTracks('43TAlCzzm5cC97LPwit4n0', {
                limit: 1,
                offset: 1
            }, function (err, data) {
                if (err) throw err;
